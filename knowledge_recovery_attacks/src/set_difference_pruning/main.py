...
modeltype2path = {
    ...
    "zephyr-7b-beta_rmu": "cais/Zephyr_RMU",
    
    "zephyr-7b-beta_rad.random": "../../checkpoints/rm/rad/random_direction/HuggingFaceH4/zephyr-7b-beta_alpha-1200-1200_coeffs-14.0-14.0_batches-500_layer-7_component-None_nu-0.0",
    "zephyr-7b-beta_rad.truth": "../../checkpoints/rm/rad/truth/truth_direction/HuggingFaceH4/zephyr-7b-beta_alpha-1200-1200_coeffs-14.0-14.0_batches-500_layer-7_component-None_nu-0.0",
    
    "zephyr-7b-beta_rab.random": "../../checkpoints/rm/rab/random_direction/HuggingFaceH4/zephyr-7b-beta_alpha-20-20_coeffs-50.0-50.0_batches-500_layer-7_component-None_nu-0.0",
    "zephyr-7b-beta_rab.truth": "../../checkpoints/rm/rab/truth/truth_direction/HuggingFaceH4/zephyr-7b-beta_alpha-20-20_coeffs-50.0-50.0_batches-500_layer-7_component-None_nu-0.0",

    "zephyr-7b-beta_rad.sentiment.positive": "../../checkpoints/rm/rad/sentiment/positive_direction/HuggingFaceH4/zephyr-7b-beta_alpha-1200-1200_coeffs-16.0-16.0_batches-500_layer-7_component-None_nu-0.0",
    "zephyr-7b-beta_rab.sentiment.positive": "../../checkpoints/rm/rab/sentiment/positive_direction/HuggingFaceH4/zephyr-7b-beta_alpha-20-20_coeffs-120.0-120.0_batches-500_layer-7_component-None_nu-0.0",

    "zephyr-7b-beta_rad.refusal": "../../checkpoints/rm/rad/refusal/refusal_direction/HuggingFaceH4/zephyr-7b-beta_alpha-1200-1200_coeffs-18.0-18.0_batches-500_layer-7_component-None_nu-0.0",
    "zephyr-7b-beta_rab.refusal": "../../checkpoints/rm/rab/refusal/refusal_direction/HuggingFaceH4/zephyr-7b-beta_alpha-20-20_coeffs-40.0-40.0_batches-500_layer-7_component-None_nu-0.0",
}
...
def get_llm(model_name, cache_dir="llm_weights"):
    ...
    ] or model_name.startswith("zephyr-7b-beta"):
    ...
    model.seqlen = min(model.config.max_position_embeddings, 1024)
    return model
    ...
    if not os.path.exists(save_filepath):
        with open(save_filepath, "w") as f:
            if not args.prune_method == "wandg_set_difference":
                print("method\tactual_sparsity", file=f, flush=True)
                print(
                    f"{args.prune_method}\t{sparsity_ratio:.6f}",
                    file=f,
                    flush=True,
                )
            else:
                print(
                    "method\tactual_sparsity\tp\tq", file=f, flush=True
                )
                print(
                    f"{args.prune_method}\t{sparsity_ratio:.6f}\t{args.p}\t{args.q}",
                    file=f,
                    flush=True,
                )
    else:
