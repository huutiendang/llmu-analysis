...
model_configs = {
    "default/zephyr-7b-beta": ModelConfig(
        model_name=None,
        peft_path=None,
    ...
    "J4Q8/zephyr-npo-bio": ModelConfig(
        model_name="J4Q8/zephyr-npo-bio",
        peft_path=None,
        response_template="<|assistant|>\n",
        first_token="",
        system_prompt=None,
    ...
    "J4Q8/zephyr-dpo-bio": ModelConfig(
        model_name="J4Q8/zephyr-dpo-bio",
        peft_path=None,
        response_template="<|assistant|>\n",
        first_token="",
        system_prompt=None,
    ...
    "J4Q8/zephyr-npo-cyber": ModelConfig(
        model_name="J4Q8/zephyr-npo-bio",
        peft_path=None,
        response_template="<|assistant|>\n",
        first_token="",
    ...
    "J4Q8/zephyr-dpo-cyber": ModelConfig(
        model_name="J4Q8/zephyr-dpo-bio",
        peft_path=None,
        response_template="<|assistant|>\n",
        first_token="",
...
def load_model(
    ...
    model = transformers.AutoModelForCausalLM.from_pretrained(
        ...
        load_in_4bit=load_in_4bit,  # TODO
    ).eval()
