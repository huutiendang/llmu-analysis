...
if __name__ == "__main__":
    ...
    args.output_dir = os.path.join(args.output_dir, 
                                   f"adv_prefixes_no_chat_template" if args.dont_apply_chat_template else f"adv_prefixes", 
                                   f"{formatted_model_name}{system_propmt_str}")
    ...
    benchmark = Benchmark(output_dir=args.output_dir,
                            ...
                            run_name=f"adv_prefixes/{args.wmdp_subset}/unlearned_model.{formatted_model_name}/use_init.{args.use_init}",
    ...
    benchmark.run(util.load_model(args.model_name_or_path, load_in_4bit=False), 
